...
\subsubsection{Bodenobjekt}
	...
	Gewicht &
		...
		E, M \\
	Design &
		Elegantes, spezielles Design (abheben von Konkurrenz) &
		&
		M \\
	Special-Effects &
		Das Gerät kann min 1 Special-Effects (Konfetti, Rauch, usw.) &
		Das Gerät kann min 3 Special-Effects (Konfetti, Rauch, usw.) &
        E, I, M \\
\end{zebratabular}		
