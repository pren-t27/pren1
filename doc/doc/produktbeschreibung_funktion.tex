...
geeigneten Treiber für den Schrittmotor sogar noch eine höhere Genauigkeit erreicht, da Zwischenschritte eingebaut werden können. Diese sind jedoch vom Trägheitsmoment der Konstruktion und vom Drehmoment des Motor abhängig. 

\subsection{Ballbeschleunigung}
\begin{figure}[h!]          
	\centering             
	\includegraphics[width=0.6\textwidth]{fig/Balllager.jpg}    
