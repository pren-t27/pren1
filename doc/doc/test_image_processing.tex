...
Für die Erkennung des Korbes wurde ein Testprogramm in Java geschrieben. Es wurden Fotos des Korbes aus verschiedenen Blickwinkeln und auf unterschiedlichem Hintergrund angefertigt. Mittels dem OpenCV-Framework, welches frei erhältlich ist, wurden verschiedene Algorithmen auf das Bild angewandt um den Eimer vom Hintergrund abzugrenzen.
