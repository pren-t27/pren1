...
Im Folgenden wird der Test von OpenCV in Zusammenarbeit mit Java beschrieben. Die Korbfindung soll mittels des frei erhältlichen OpenCV-Frameworks ausgeführt werden.
