...
\begin{table}[h!]
    ...
    %\begin{zebratabular}{@{}p{0.23\linewidth}llllll}
        ...
        Korberkennung &
            Distanz\-messung            \tikzmark{1localize:dist}     &
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \draw [ultra thick, rounded corners, red] 
            ...
            ;
    \end{tikzpicture}
    \caption{Morphologischer Kasten Bodenobjekt fahrend}
\end{table}
\normalsize
...
\begin{table}[h!]
    ...
    %\begin{zebratabular}{@{}p{0.23\linewidth}llllll}
        ...
        Korberkennung &
            Distanz\-messung            \tikzmark{2localize:dist}     &
...
\begin{table}[h!]
    ...
    %\begin{zebratabular}{@{}p{0.23\linewidth}llllll}
        ...
        Korberkennung &
            Distanz\-messung            \tikzmark{3localize:dist}     &
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \draw [ultra thick, rounded corners, red] 
            ...
            --
            ({pic cs:3power:elext}) circle(2pt)
            ;
    \end{tikzpicture}
