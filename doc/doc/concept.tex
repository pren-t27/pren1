...
=======
% Beispiel für das Einfügen einer Grafik -- Bitte bei weiterverwendung Kommentare entfernen
\begin{figure}[h!]          % Box für die Grafik
    \centering              % Grafik zentriert

    % Grafik einfügen
    % Breite ist halbe Textbreite
    % Pfad zum Bild ist relativ
    \includegraphics[width=0.5\textwidth]{fig/bild.png}
